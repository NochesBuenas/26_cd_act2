...
with tab1:
    st.header("Gatos")
    st.image("https://purina.com.co/sites/default/files/2025-05/razas-de-gatos.jpg", width=200)

with tab2:
    st.header("Perros")
    st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN4HJhnJo07reTM0Lta1HoTollHloqsqRUVw&s", width=200)
    
with tab3:
    st.header("Aves")
    st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUADt6Lv1lC4X9v-su-EuiRA2BtE8XETcgMQ&s", width=200)
